...
-- DROP TABLE IF EXISTS campaigndata;

CREATE TABLE IF NOT EXISTS campaigndata
(
    campaign_id VARCHAR(6) ,
    company VARCHAR20) ,
    campaign_type VARCHAR(12) ,
    target_audience VARCHAR(11) ,
    duration VARCHAR(7),
    channel_used VARCHAR(10) ,
...
###### Output of the table:
|campaignid | company | roi |
|---| --- | --- |
| 168 | NextGen Systmes | 8|
...
## Conclusion
###### 1. The analysis of the 200,005 campaigns provides valuable insights into the effectiveness of various digital marketing efforts.

###### 2. NextGen Systems achieved the highest Return on Investment (ROI) at 800%, demonstrating strong revenue generation.

###### 3.  In terms of reach, New York, Miami, and Chicago led in impressions, with over 219 million impressions each.
